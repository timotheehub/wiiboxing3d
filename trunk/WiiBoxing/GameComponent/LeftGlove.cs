...
namespace WiiBoxing3D.GameComponent {
	...
	public class LeftGlove : Glove {
        public const Vector3 OFF_SET = new Vector3(5, 1, 0);      //original position w.r.t player position
        ...
        public override void Update(GameTime GameTime)
        {
            ...
            //    player_position = Player.Position();                       //how to get player's current position?
